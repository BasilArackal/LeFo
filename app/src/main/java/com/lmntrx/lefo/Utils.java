...
public class Utils {
    ...
    public static void onActivityCreateSetTheme(Activity activity) {
        if (sTheme==0 || sTheme==1)
            switch (sTheme)
            { default:
                case 0: activity.setTheme(R.style.AppTheme_Light_NoActionBar);
                         View view = activity.getWindow().getDecorView();
                         view.setBackgroundColor(Color.WHITE); break;
                case 1: activity.setTheme(R.style.AppTheme_Dark_NoActionBar);
            ...
            switch (sTheme)
            { default:
                case 2: activity.setTheme(R.style.AppTheme);
                    View view = activity.getWindow().getDecorView();
                    view.setBackgroundColor(Color.WHITE); break;
                case 3: activity.setTheme(R.style.AppTheme_Dark);
                    View view2 = activity.getWindow().getDecorView();
                    view2.setBackgroundColor(Color.BLACK);
                    Utils obj= new Utils();
                    obj.showtoast(activity);
